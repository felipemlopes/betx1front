          ...
          <div class="card border-0" style="background:transparent;">
            <div class="card-body">
              <ul class="nav nav-pills navtab-bg nav-justified">
                ...
                <li class="nav-item">
                  <NuxtLink :to="{ name:'conta-historico'}" data-toggle="tab" aria-expanded="false" class="nav-link active">
                    <span class="">Histórico</span>
                  </NuxtLink>
                </li>
                <li class="nav-item">
                  <NuxtLink :to="{ name:'conta-transacoes-depositos'}" data-toggle="tab" aria-expanded="false" class="nav-link">
                      ...
                      <div class="card border-0 bg-dark">
                        <div class="card-body">
                          ...
                          <div class="row table-header d-none d-sm-none d-md-block d-lg-block d-lg-block">
                            ...
                            <div class="col-sm-3 text-center">Jogo</div>
                            <div class="col-sm-2 text-center">Valor</div>
                            <div class="col-sm-2 text-center">Multiplicador</div>
                            <div class="col-sm-3 text-center">Lucro</div>
                          </div>
                          ...
                          <div class="row table-line" v-for="(item, index) in this.bets">
                            <div class="col-sm-2 col-12 text-center">
                              ...
                              <span class="badge" :class="item.status_class">{{item.status}}</span>
                              <br>
                              {{item.created_at}}
