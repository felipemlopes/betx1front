          ...
          <div class="card border-0" style="background:transparent;">
            <div class="card-body">
              <ul class="nav nav-pills navtab-bg nav-justified">
                <li class="nav-item">
                  <NuxtLink :to="{ name:'conta'}" data-toggle="tab" aria-expanded="false" class="nav-link">
                    <span class="">Perfil</span>
                  </NuxtLink>
                </li>
                <li class="nav-item">
                  <NuxtLink :to="{ name:'conta-historico'}" data-toggle="tab" aria-expanded="false" class="nav-link">
                    <span class="">Histórico</span>
                  </NuxtLink>
                </li>
                <li class="nav-item">
                  <NuxtLink :to="{ name:'conta-transacoes-depositos'}" data-toggle="tab" aria-expanded="false" class="nav-link active">
                    <span class="">Transações</span>
                  </NuxtLink>
                </li>
                <li class="nav-item">
                  <NuxtLink :to="{ name:'conta-senha'}" data-toggle="tab" aria-expanded="false" class="nav-link">
                ...
                <div class="tab-pane active">
                  <div class="row mt-3">
                    <div class="col-md-3">
                      <div class="card border-0 bg-dark">
                        <div class="card-body">
                          ...
                          <NuxtLink :to="{ name:'conta-transacoes-depositos'}" class="dropdown-item active">
                            <fa-icon :icon="faPlusSquare" style="margin-right: 10px;"/>
                            Depósitos
                          </NuxtLink>
                          <NuxtLink :to="{ name:'conta-transacoes-saques'}" class="dropdown-item">
                    ...
                    <div class="col-md-9">
                      <div class="card border-0 bg-dark">
                        <div class="card-body">
                          <h3 class="text-white">Depósitos</h3>
...
export default {
  ...
  methods: {
    async getTransactions() {
      await this.$axios.get("/laravel/api/account/transactions/deposits?page="+this.page)
        .then(res => {
