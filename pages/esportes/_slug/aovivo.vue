  ...
  <div class="container">
    ...
    <div class="row">
          ...
          <div class="card-body py-2 px-2">
            ...
            <div class="mt-2">
              ...
              <ul class="nav nav-tabs">
                <li class="nav-item">
                  <nuxt-link :to="{ name:'esportes-slug-aovivo', params:{slug:this.$route.params.slug}}" class="nav-link active">Ao vivo</nuxt-link>
                </li>
                <li class="nav-item">
                  <nuxt-link :to="{ name:'esportes-slug-proximos', params:{slug:this.$route.params.slug}}" class="nav-link">Próximos</nuxt-link>
                </li>
                <li class="nav-item">
      ...
      <div class="col-md-12">
        ...
        <div class="row">
          <FrontLivematches :sport_slug="this.$route.params.slug"></FrontLivematches>
        </div>
