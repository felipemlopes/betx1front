<template>
  ...
  <div class="container">
    ...
    <div class="row">
          ...
          <div class="card-body py-2 px-2">
            ...
            <div class="mt-2">
              ...
              <ul class="nav nav-tabs">
                ...
                <li class="nav-item">
                  <nuxt-link :to="{ name:'esportes-slug-paises', params:{slug:this.$route.params.slug}}" class="nav-link active">Países</nuxt-link>
                </li>
              </ul>
      ...
      <div class="col-md-12 ">
        <FrontCountries :sport_slug="this.$route.params.slug"></FrontCountries>
      </div>
