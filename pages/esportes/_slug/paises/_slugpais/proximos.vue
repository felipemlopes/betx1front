        ...
        <div class="card-body py-2 px-2">
          ...
          <div class="mt-2">
            <ul class="nav nav-tabs">
              ...
              <li class="nav-item">
                <nuxt-link :to="{ name:'esportes-slug-paises-slugpais-proximos', params:{slug:this.$route.params.slug}}" class="nav-link active">Próximos</nuxt-link>
              </li>
            </ul>
          </div>
        </div>
...
export default {
  ...
  methods: {
    ...
    getChampionships() {
      this.$axios.get("/laravel/api/sportsbook/sports/"+this.$route.params.slug+"/championship/next?country="+this.$route.params.slugpais)
        .then(res => {
    ...
    getMatches() {
      this.$axios.get("/laravel/api/sportsbook/sports/"+this.$route.params.slug+"/nextmatches?country="+this.$route.params.slugpais)
        .then(res => {
