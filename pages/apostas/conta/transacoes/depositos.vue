                    ...
                    <div class="col-md-3">
                      <div class="card border-0 bg-dark" style="background-color: #303841 !important;">
                        <div class="card-body">
                          ...
                          <NuxtLink :to="{ name:'apostas-conta-transacoes-depositos'}" class="dropdown-item active">
                            <fa-icon :icon="faPlusSquare" style="margin-right: 10px;"/>
                            Depósitos
                          </NuxtLink>
                          <NuxtLink :to="{ name:'apostas-conta-transacoes-saques'}" class="dropdown-item">
...
export default {
  ...
  methods: {
    async getTransactions() {
      this.$axios.get("/laravel/api/account/transactions/deposits?page="+this.page)
        .then(res => {
