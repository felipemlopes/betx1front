    ...
    <div class="navbar-custom">
      <div class="container-fluid">
        <ul class="list-unstyled topnav-menu float-end mb-0">
          ...
          <li class="dropdown notification-list px-2 py-2" v-show="this.$cookies.get('tokenauth')">
            <div class="dropdown">
              ...
              <ul class="dropdown-menu" :class="{ 'show': usermenushow }">
                <li>
                  <NuxtLink :to="{ name:'Apostas-conta'}" class="dropdown-item">
                    <fa-icon :icon="faUserAlt" style="margin-right: 10px;"/>
                    Conta
                  </NuxtLink>
                  <NuxtLink :to="{ name:'Apostas-conta-deposito'}" class="dropdown-item">
                    <fa-icon :icon="faPlusSquare" style="margin-right: 10px;"/>
                    Depositar
                  </NuxtLink>
                  <NuxtLink :to="{ name:'Apostas-conta-saque'}" class="dropdown-item">
                  ...
                  <NuxtLink :to="{ name:'Apostas-conta-transacoes'}" class="dropdown-item">
                    <fa-icon :icon="faReceipt" style="margin-right: 10px;"/>
                    Transações
                  </NuxtLink>
                  <NuxtLink :to="{ name:'Apostas-conta-historico'}" class="dropdown-item">
          ...
          <li class="dropdown notification-list px-2 py-2" v-show="this.$cookies.get('tokenauth')">
            <NuxtLink :to="{ name:'Apostas-conta-deposito'}" class="nav-link right-bar-toggle btn btn-primary text-uppercase fw-bold fs-5 ">
              Depositar
            </NuxtLink>
          </li>
