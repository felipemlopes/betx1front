<template>
  <div>
    <div class="left-side-menu" :class="{ 'd-none': this.$store.state.sidebar.sidebaraposta }">
              ...
              <div class="simplebar-content" style="padding: 0px;">
                ...
                <div id="sidebar-menu">
                  ...
                  <ul id="side-menu">
                    ...
                    <li>
                      <NuxtLink :to="{ name:'apostas-promocoes-id', params:{id:promotion.id}  }" class="btn btn-primary btn-block mx-2 fw-bold fs-5">
                    ...
                    <li class="menu-title mt-2 text-white text-uppercase fw-bold fs-5 pointer" style="pointer-events: auto;">
                      <NuxtLink :to="{ name:'apostas' }" class="text-white pointer">
                        <span class="text-white"> Esportes </span>
                      </NuxtLink>
                    </li>

                    <li v-for="(item, index) in this.sports">
                      <NuxtLink :to="{ name:'apostas-esportes-slug', params:{slug:item.reference}  }">
